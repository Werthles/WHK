...
//private variables
private ["_recurrent", "_timeBetween", "_debug", "_advanced", "_startDelay", "_pause", "_report", "_badNames", "_moreBadModules", "_syncGroup", "_trigSyncs", "_waySyncs", "_objSyncs", "_objs", "_wayPoint", "_counts", "_null", "_localCount", "_stringInfo1", "_stringInfo2", "_stringInfo3", "_Info", "_transfers", "_recurrentCheck", "_ll", "_who", "_amount", "_whom", "_inheadlessArray", "_headlessCount", "_unitsInGroup", "_groupMoving", "_size", "_lead", "_leadOwner", "_leadHeadless", "_moveToHC", "_bad", "_syncTrigArray", "_syncWayArray", "_wayNum", "_syncedTrigs", "_syncedWays", "_syncObjectsArray", "_syncObjects", "_nameOfSync", "_found", "_zz", "_HC", "_fewest", "_local", "_newSum", "_stringInfo4", "_strTransfers", "_strRecurrent", "_confirmation"];
...
_badNames = ["ignore"]; // + _moreBadModules;
